...
namespace KYM
{
    public class PlayerHUD : UIBase
    {
        ...
        public void OnclickGoToTitleButton() 
        {
            ...
            {
                UIManager.Hide<PlayerHUD>(UIList.PlayerHUD); // PlayerHUD 숨김
                UIManager.Hide<CharacterInfoUI>(UIList.CharacterInfoUI); // CharacterInfoUI 숨김
                UIManager.Hide<MenuUI>(UIList.MenuUI); // MenuUI 숨김
                UnityEngine.SceneManagement.SceneManager.LoadScene("Title"); // "Title" 씬으로 전환
